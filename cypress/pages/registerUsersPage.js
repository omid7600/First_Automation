...
class registerUserPage{
    ...
    elements = {
        ...
        emailNewAccountInput:()=>cy.xpath('.accountNew > .formInput.formInput--text > .formInput__inputContainer > #email'),
        passwordInput:()=>cy.xpath('//input[@id="password"]'),
        passwordRepInput:()=>cy.xpath('//input[@id="password2"]'),
        checkboxNewsletter:()=>cy.xpath('.accountNew__newsletterCheckbox >.accountNew__checkbox >.checkbox.checkbox--alignTop'),
        checkBoxRuleApprove:()=>cy.xpath('.accountNew__agbCheckbox > .accountNew__checkbox > .checkbox.checkbox--alignTop'),
